            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <a
                            href={hostUrl.startsWith('http') ? hostUrl : '#'}
                            target="_blank"
                ...
                <iframe
                    src={hostUrl.startsWith('http') ? hostUrl : 'about:blank'}
                    style={{ flex: 1, border: 'none', backgroundColor: '#fff' }}
                    title="Dockge Interface"
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '16px' : '20px' }}>
                    ...
                    <div>
                        <h1
                            ...
                            style={{ margin: 0, fontSize: isMobile ? '24px' : undefined }}
                        >
                            Dockge Stacks
                        </h1>
                        <p
                ...
                >
                    ...
                    <div>
                        <div style={{ fontWeight: 600, fontSize: '20px', marginBottom: '4px' }}>
                            Dockge URL Not Configured
                        </div>
                        <div style={{ fontSize: '16px', opacity: 0.7 }}>
                            Please provide your Dockge instance URL in Global Settings to enable the integrated view.
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="md3-card-elevated col-span-12 md-col-span-12" style={{ padding: '32px' }}>
                    ...
                    >
                        ...
                        <div style={{ textAlign: 'center', padding: isMobile ? '0 16px' : '0' }}>
                            <p style={{ fontSize: isMobile ? '16px' : '18px', fontWeight: 500, margin: '0 0 8px 0' }}>
                                Data integration for Dockge is handled via the full interface.
                            </p>
                            <p style={{ fontSize: '14px', color: 'var(--md-sys-color-on-surface-variant)' }}>
                                Dockge uses real-time WebSockets which are best experienced through the native UI.
                            </p>
                        </div>
                        {hostUrl && (
                            <button
