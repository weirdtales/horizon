    ...
    if (!View) {
        return (
            ...
            >
                ...
                <h1 style={{ fontSize: '32px', fontWeight: 900, marginTop: '24px', letterSpacing: '-0.02em' }}>
                    Module Not Found
                </h1>
                <p style={{ opacity: 0.6, maxWidth: '440px', fontSize: '16px', lineHeight: 1.6 }}>
                    The module <strong>&quot;{hubId}&quot;</strong> is not installed or does not have a registered full
                    view.
                </p>
                <Link
                    href="/"
