...
export default function PlexWidget() {
    const { data, loading, error } = useService<{
        ...
        libraries: { id: string; count: number; title: string }[];
    }>('plex');
        ...
        >
            ...
            <div
                style={{
                    ...
                    background:
                        activeSession?.art && sanitizeUrl(activeSession.art)
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                ...
                                >
                                    {sanitizeText(data.server?.name || '', 'Media Center')}
                                </div>
                            </div>
                            <div
                                style={{
                            ...
                            >
                                v{sanitizeText(data.server?.version?.split('-')[0] || '', 'Unknown')}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    {activeSession ? (
                        ...
                        >
                            ...
                            <div style={{ minWidth: 0, flex: 1 }}>
                                ...
                                >
                                    {activeSession.player} • {activeSession.user}
                                </div>
                                <div
                                    style={{
                                        marginTop: '8px',
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{ fontSize: '20px', fontWeight: 900, letterSpacing: '-0.02em' }}>
                                    {(Number(lib.count) || 0).toLocaleString()}
                                </div>
                                <div
                                    style={{
                                        fontSize: '8px',
