...
import { PlaySquare, Database, Loader2, Monitor, Activity, RefreshCw, Layers, ShieldCheck } from 'lucide-react';
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px', animation: 'fadeIn 0.5s ease' }}>
                ...
                >
                    ...
                    <StatCard
                        ...
                        value={
                            data?.libraries?.reduce((acc: number, l: PlexLibrary) => acc + (Number(l.count) || 0), 0) ||
                            0
                        }
                        sub="Managed items"
                        icon={Database}
                    ...
                    <StatCard
                        ...
                        sub={error ? 'Link severed' : 'Low-latency link'}
                        icon={ShieldCheck}
                        color={error ? 'var(--md-sys-color-error)' : '#4ade80'}
                        delay={0.4}
                    />
                </div>
                    ...
                    {!data?.sessions || data.sessions.length === 0 ? (
                        ...
                        >
                            {data.sessions.map((session: PlexSession, i: number) => (
                                <div
                                    key={session.sessionKey || `session-${i}`}
                                    className="md3-card-elevated"
                                    style={{
                                        position: 'relative',
                                        overflow: 'hidden',
                                        ...
                                        >
                                            ...
                                            <div
                                                style={{
                                                    ...
                                                    inset: 0,
                                                    background:
                                                        'linear-gradient(to bottom, var(--md-sys-color-surface-container-low), transparent, var(--md-sys-color-surface-container-low))',
                                                }}
                                            />
                                        </div>
                                    )}
