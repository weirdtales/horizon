...
export default function LoopiaView() {
    ...
    const { data: domainsData, loading: domainsLoading } = useService<{
        domains: LoopiaDomain[];
        totals: { count: number; active_zones: number };
    }>('loopia/domains', 300000);

    const { data: subsData, loading: subsLoading } = useService<{ subdomains: string[] }>(
    ...
    } = useService<{ records: DNSRecord[] }>(
        selectedDomain && selectedSubdomain
            ? `loopia/records?domain=${selectedDomain}&subdomain=${selectedSubdomain}`
            : 'loopia/domains',
                ...
                >
                    ...
                    >
                        <h3 style={{ margin: 0, fontSize: '20px', fontWeight: 800 }}>
                            {isAdding ? 'Add DNS Record' : 'Edit DNS Record'}
                        </h3>
                        <button
                            onClick={() => {
                                setEditingRecord(null);
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                ...
                                <input
                                    ...
                                    value={record.ttl}
                                    onChange={e =>
                                        setEditingRecord({ ...record, ttl: parseInt(e.target.value) || 3600 })
                                    }
                                    style={{
                                        padding: '12px 16px',
                                        background: 'var(--md-sys-color-surface-container)',
                            ...
                            {record.type === 'MX' || record.type === 'SRV' ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            setEditingRecord({ ...record, priority: parseInt(e.target.value) || 0 })
                                        }
                                        style={{
                                            padding: '12px 16px',
                                            background: 'var(--md-sys-color-surface-container)',
                            ...
                            >
                                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        <div style={{ fontSize: '11px', opacity: 0.5, fontWeight: 700 }}>
                                            TTL: {record.ttl} • ID: {record.record_id}{' '}
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    ...
                                    <button
                                        onClick={() => {
                                            if (record.record_id) handleDeleteRecord(record.record_id);
                                        }}
                                        className="m3-press-effect"
                                        style={{
                                            background: 'none',
                        ...
                        {(!recordsData?.records || recordsData.records.length === 0) && (
                            ...
                            >
                                ...
                                <div style={{ fontSize: '12px' }}>
                                    This subdomain currently has no DNS records defined.
                                </div>
                            </div>
                        )}
                    </div>
            ...
            <div style={{ padding: '0px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: '12px', opacity: 0.5, fontWeight: 700, textTransform: 'uppercase' }}>
        ...
        <div style={{ padding: '0px' }}>
            ...
            >
                ...
                >
                    ...
                    <div style={{ fontSize: '36px', fontWeight: 900, color: '#4ade80' }}>
                        {domainsData?.totals?.active_zones || 0}
                    </div>
                </div>
                <div
                    className="md3-card-elevated"
            ...
            <section>
                ...
                >
                    ...
                    <span style={{ fontSize: '12px', fontWeight: 700, opacity: 0.5 }}>
                        {domainsData?.domains?.length || 0} records
                    </span>
                </div>
