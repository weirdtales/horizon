...
export default function SonarrWidget() {
    const { data, loading, error } = useService<{
        queue: { id: string | number; title: string; progress: number | string }[];
        ...
        >
            <div
                style={{
                    ...
                    right: 0,
                    height: '40%',
                    background: 'linear-gradient(to bottom, rgba(60, 155, 220, 0.08), transparent)',
                    pointerEvents: 'none',
                }}
            />
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div
                        style={{
                            backgroundColor: 'color-mix(in srgb, #3c9bdc 15%, transparent)',
                            color: '#3c9bdc',
                            padding: '10px',
                            borderRadius: '14px',
                            border: '1px solid color-mix(in srgb, #3c9bdc 30%, transparent)',
                        }}
                    >
                        <Video size={20} />
                    </div>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '16px' }}>
                {hasQueue ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        {data.queue
                            .slice(0, 2)
                            .map((item: { id: string | number; title: string; progress: number | string }) => {
