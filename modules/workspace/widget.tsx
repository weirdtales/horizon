...
export default function WorkspaceWidget() {
    const { data, loading, error } = useService<{
        unread: number;
        events: { title: string; start: string; isAllDay: boolean }[];
        tasks: number;
    }>('workspace');
        ...
        return (
            ...
            >
                ...
                <div style={{ fontSize: '11px', opacity: 0.6, textAlign: 'center' }}>
                    {typeof error === 'string' ? error : 'Check Workspace settings'}
                </div>
            </div>
        );
    }
        ...
        >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', flex: 1 }}>
                ...
                >
                    ...
                    <div style={{ fontSize: '10px', fontWeight: 800, opacity: 0.6, textTransform: 'uppercase' }}>
                        Unread
                    </div>
                </div>
                <div
